<template>
  <div class="aside">
    ...
    <div class="history">
      <h5>历史查询</h5>
      <nuxt-link 
      v-for="(item,index) in $store.state.air.lishijilu" :key="index"
...
//   },
//   mounted() {
//     const n1 = this.$store.state.air.lishijilu;
//     this.lishijilu = n1;
//     console.log(this.lishijilu);
//     console.log(this.$store.state.air.lishijilu);
//   }
};
</script>
